...
/*
PFNGLDRAWARRAYSINSTANCEDARBPROC     pglDrawArraysInstancedARB = 0;
PFNGLDRAWELEMENTSINSTANCEDARBPROC   pglDrawElementsInstancedARB = 0;
PFNGLVERTEXATTRIBDIVISORARBPROC     pglVertexAttribDivisorARB = 0;
*/
...
void glExtension::getFunctionPointers()
{
    ...
    for(int i = 0; i < (int)extensions.size(); ++i)
    {
        ...
        else if(extensions[i] == "GL_ARB_draw_buffers")
        {
        ...
        else if(extensions[i] == "GL_ARB_instanced_arrays")
        {
            ...
            /*
            glDrawArraysInstancedARB   = (PFNGLDRAWARRAYSINSTANCEDPROC)wglGetProcAddress("glDrawArraysInstancedARB");
            glDrawElementsInstancedARB = (PFNGLDRAWELEMENTSINSTANCEDPROC)wglGetProcAddress("glDrawElementsInstancedARB");
            glVertexAttribDivisorARB   = (PFNGLVERTEXATTRIBDIVISORPROC)wglGetProcAddress("glVertexAttribDivisorARB");
            */
        }
