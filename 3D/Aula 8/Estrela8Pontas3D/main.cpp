...
void EspecificaParametrosVisualizacao(){
	...
	gluLookAt(10, 10, 15, 0,0,0, 0,1,0); //(20,80,200, 0,0,0, 0,1,0); (fovy 10)
...
void estrelaDe8PontasRipas(float lado, float alpha){
    ...
    //coloca a ponta extrema de CIMA
    glPushMatrix();
...
void Inicializa (){
	...
	glClearColor(0.0f, 0.5f, 0.0f, 1.0f); // Especifica que a cor de fundo da janela será Verde
...
int main(int argc, char *argv[]){
    ...
    glutCreateWindow("Estrela 8 Pontas 3D");
