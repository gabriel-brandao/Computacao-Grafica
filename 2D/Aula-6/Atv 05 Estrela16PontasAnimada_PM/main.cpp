...
void estrelaDe8Pontas (float R, float alpha){ //desenha estrela com linhas
    vector <float> Pm (2);
...
void estrelaDe8PontasRipas(float L, float alpha){ //desenha estrela com ripas
    vector <float> Pm (2);
...
int main(int argc, char *argv[]){
    ...
    glutCreateWindow("Estrela de 16 Pontas Animada Ponto Medio");
